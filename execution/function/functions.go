...
// dateTimeFunc creates a functionCall for date/time functions that take an instant vector argument.
...
// dateTimeNoArgFunc creates a noArgFunctionCall for date/time functions with no argument.
