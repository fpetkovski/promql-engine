...
func (c logicalVectorSelector) MakeExecutionOperator(vectors *model.VectorPool, _ logicalplan.Scanners, opts *query.Options, hints storage.SelectHints) (model.VectorOperator, error) {
